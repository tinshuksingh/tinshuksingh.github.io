...
export class AppComponent implements OnInit, OnDestroy {
  ...
  // navTitleLogo = require('../assets/nav-title-logo.png');
  // languages = ['en', 'de', 'sk', 'fr', 'es'];
  languages = ['en'];
  navigation = [
    { link: 'home', label: 'cr.menu.home' },
    { link: 'invoice', label: 'cr.menu.invoice' },
    { link: 'about', label: 'cr.menu.about' }
  ];
  navigationSideMenu = [
    ...this.navigation,
    { link: 'settings', label: 'cr.menu.settings' }
  ];
